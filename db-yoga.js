...
const DB_YOGA = [
  // ============== STANDING ASANAS (14種) ==============
  {
    ...
    why:'すべての立位アサナの土台。',
    breath:'自然な呼吸で、足裏から頭頂まで上下に長く伸びる。',
    modify:'壁を背にすると背骨の整列を感じやすい。'
  },
  {
    ...
    breath:'両腕を頭上に上げる時に吸い、前膝へ沈む時に吐く。',
    modify:'歩幅を狭く、前膝の曲げを浅く。腕は腰に当てたままでもOK。'
  },
  {
    ...
    breath:'両腕を水平に開く時に吸い、キープ中は自然な呼吸を続ける。',
    modify:'前膝の曲げを浅く。つらければ時間を短く区切って。'
  },
  {
    ...
    why:'バランス感覚＋臀筋＋ハム強化。',
    breath:'上体を前に倒す時に吐き、キープ中は呼吸を止めない。',
    modify:'壁や椅子に手を添えて。後脚のつま先を床につけたままでもOK。'
  },
  {
    ...
    breath:'吐きながら体側を倒し、吸って軽く戻す。',
    modify:'下の手はすねかブロックに置く。倒す角度は浅くてOK。'
  },
  {
    ...
    why:'胸椎回旋＋ハムストリング。',
    breath:'吐きながら胸を捻り上げる。',
    modify:'後ろかかとを上げてOK。下の手はブロックか脛に置く。'
  },
  {
    ...
    why:'脚と背中の同時強化。',
    breath:'両腕を上げながら吸い、膝を曲げて座る時に吐く。',
    modify:'膝の曲げを浅く。腕は前ならえの高さでもOK。'
  },
  {
    ...
    why:'バランス感覚と精神集中。',
    breath:'自然な呼吸を続け、視線を一点に定めて安定させる。',
    modify:'足はふくらはぎか足首に（膝の横は避ける）。壁に手を添えてOK。'
  },
  {
    ...
    why:'肩甲骨間の凝りを解放。',
    breath:'自然な呼吸で、吐く息のたびに肩甲骨の間を広げる。',
    modify:'腕だけ・脚だけの絡めでもOK。バランスは壁の近くで。'
  },
  {
    ...
    breath:'吸って胸を開きながら、後ろ脚を持ち上げる。',
    modify:'壁に手を添えて。後ろ脚は低くてOK、まずバランス優先で。'
  },
  {
    ...
    why:'バランス・柔軟性・筋力の融合。',
    breath:'吐きながら開き、キープ中は呼吸を続ける。',
    modify:'下の手はブロックに。壁を背にすると安定しやすい。'
  },
  {
    ...
    why:'体側＋脚＋胸郭の総合。',
    breath:'吐きながら体側を、かかとから指先まで長く伸ばす。',
    modify:'前肘を前膝に乗せると楽。上の腕は耳の横まででOK。'
  },
  {
    ...
    why:'股関節と足首の全モビリティ。',
    breath:'吐きながら深くしゃがみ、肘で内ももを押し広げる。',
    modify:'かかとが浮けば下にタオルを敷く。壁を背にすると安定する。'
  },
  {
    ...
    why:'血流逆転で頭スッキリ。',
    breath:'吐く息のたびに上体を少しずつ前に垂らす。',
    modify:'膝を大きく曲げてOK。手は床につかなくてよい。'
  },
  ...
  // ============== SEATED ASANAS (12種) ==============
  {
    ...
    why:'すべての座位アサナの土台。',
    breath:'背筋を伸ばし、深くゆったりと呼吸する。',
    modify:'お尻の下に座布団を敷くと骨盤が立ちやすい。壁を背にしてもOK。'
  },
  {
    ...
    why:'股関節内側の柔軟性。',
    breath:'吐きながら股関節をゆるめ、膝を床へ近づける。',
    modify:'かかとを体から離すと楽。お尻の下に座布団を敷くと背筋が伸びる。'
  },
  {
    ...
    why:'柔軟性の代表指標。',
    breath:'吐く息のたびに、股関節から少しずつ前へ。',
    modify:'膝を曲げてOK。タオルを足裏にかけて軽く引くと届きやすい。'
  },
  {
    ...
    why:'内臓マッサージ＋胸椎回旋。',
    breath:'吸って背筋を伸ばし、吐きながら胸から捻る。',
    modify:'捻りは浅くてOK。手は軽く添えるだけでも十分。'
  },
  {
    ...
    why:'肩関節の柔軟性を片側ずつ。',
    breath:'自然な呼吸で、吐く息のたびに肩をゆるめる。',
    modify:'手が届かなければタオルを上下の手でつなぐ。前傾せず背筋を保つ。'
  },
  {
    ...
    why:'大腿前面の柔軟性回復。',
    breath:'深く呼吸しながら前ももの伸びを感じる。',
    modify:'お尻の下にクッションを挟むと膝が楽。違和感があれば中止。'
  },
  {
    ...
    why:'左右差を整える。',
    breath:'吐きながら伸ばした脚の方へ上体を倒す。',
    modify:'膝を軽く曲げてOK。届かなければタオルを足裏にかけて。'
  },
  {
    ...
    why:'梨状筋・坐骨神経痛予防。',
    breath:'吐く息のたびにお尻の伸びを深める。',
    modify:'前膝の下にクッションを。上体は起こしたままでもOK。'
  },
  {
    ...
    why:'股関節外側の最終形。',
    breath:'吐きながら前傾し、外ももの伸びを深める。',
    modify:'上の脚を下の膝の前に置く形（楽なあぐら）でOK。痛みは出さない。'
  },
  {
    ...
    why:'QL・体側のリセット。',
    breath:'吐きながら体側を長く伸ばす。',
    modify:'お尻が浮かない範囲で。あぐらがつらければ椅子に座って行ってもOK。'
  },
  {
    ...
    why:'高度な柔軟性を求める人へ。',
    breath:'吐きながら少しずつ脚を伸ばす。',
    modify:'膝を曲げたままでOK。届く範囲で、痛みは出さない。'
  },
  {
    ...
    why:'瞑想姿勢の準備。',
    breath:'自然な呼吸で股関節をゆっくり開いていく。',
    modify:'足はふくらはぎの上でOK。膝が浮けば下にクッションを。'
  },
  ...
  // ============== PRONE / BACKBEND (10種) ==============
  {
    ...
    why:'胸椎伸展の最重要ポーズ。',
    breath:'息を吸いながら胸を持ち上げ、吐いて肩を下げて安定させる。',
  ...
  },
  {
    ...
    why:'胸郭オープンの初心者版。',
    breath:'自然な呼吸を続けながら、吐く息で肩を下げて胸を開く。',
    modify:'前腕を少し前に置くと負荷が軽くなる。首がつらければあごを軽く引く。'
  },
  {
    ...
    why:'力強い胸郭オープン。',
    breath:'息を吸いながら腕で押し、胸を前へ持ち上げる。',
    modify:'きつければコブラかスフィンクスに。膝を床につけたままでもOK。'
  },
  {
    ...
    why:'背中の総合強化。',
    breath:'息を吸いながら手脚と胸を持ち上げ、吐いて下ろす。',
    modify:'上半身だけ→次に脚だけ、と分けて行うと楽。まず5秒キープから。'
  },
  {
    ...
    why:'胸郭オープンの最終形。',
    breath:'息を吸いながら足で手を蹴り胸を開く。キープ中は呼吸を止めない。',
    modify:'片脚ずつ（ハーフ弓）でOK。足首に届かなければタオルをかけて掴む。'
  },
  {
    ...
    why:'閉じた姿勢を一気に開く。',
    breath:'息を吸いながら胸を天井へ押し上げ、吐いて安定させる。',
    modify:'かかとに手が届かなければ腰に手を当てたままでOK。首は倒さず前を見る。'
  },
  {
    ...
    why:'前面ストレッチ＋臀筋強化。',
    breath:'息を吐きながらお尻を持ち上げ、吸って軽く下ろす。',
    modify:'お尻の高さは低くてOK。首は動かさず、つらければ手を組まない。'
  },
  {
    ...
    why:'柔軟性と筋力の融合。',
    breath:'吸いながら腕で押し上げ、キープ中も呼吸を止めない。',
    modify:'橋のポーズ（セツバンダ）で代用OK。肩・手首に不安があれば避ける。'
  },
  {
    ...
    why:'寝ながらできる胸郭オープン。',
    breath:'深くゆっくり呼吸し、胸が開くのを感じる。',
    modify:'タオルの厚みを調整。首がつらければ低くする。'
  },
  {
    ...
    why:'就寝前の最強ルーティン。',
    breath:'吐く息で膝を横に倒し、ゆっくり深呼吸を続ける。',
    modify:'膝の下にクッションを置くと楽。両肩が床から浮かない範囲で。'
  },
  ...
  // ============== RESTORATIVE & BREATH (14種) ==============
  {
    ...
    why:'いつでも戻れる安全地帯。',
    breath:'深い呼吸で背中を膨らませるように、ゆっくり吐く。',
    modify:'膝を開くと楽。額が床につかなければ重ねた手やクッションにのせる。'
  },
  {
    ...
    why:'血流逆転＋全身ストレッチ。',
    breath:'吐きながらお尻を高く引き上げ、背中を長く伸ばす。',
    modify:'膝を軽く曲げてOK。かかとは床につかなくてよい。'
  },
  {
    ...
    why:'夕方のむくみリセット。',
    breath:'目を閉じてゆっくり深呼吸を続け、5分ゆだねる。',
    modify:'お尻と壁の距離を調整。腰がつらければ少し離す。'
  },
  {
    ...
    why:'ヨガの最重要ポーズ。',
    breath:'呼吸を整えようとせず、自然に任せて全身を脱力する。',
    modify:'腰がつらければ膝下にクッションを。時間は短くてもOK。'
  },
  {
    ...
    why:'集中力と熱の生成。',
    breath:'吸う・吐くを同じ長さに保ち、喉の「海の音」を一定に響かせる。',
    modify:'3分がつらければ1分から。座位が大変なら椅子に腰かけて。'
  },
  {
    ...
    why:'自律神経のバランス調整。',
    breath:'片鼻ずつ、吸う・吐くを均等にゆっくり。左右で1サイクル。',
    modify:'指が疲れたら休んでOK。まず1〜2分から始める。'
  },
  {
    ...
    why:'お腹引き締め＋脳活性化。',
    breath:'短く強く鼻から吐き、吸うのは力を抜いて自然に任せる。',
    modify:'回数を減らし、めまいがしたら中止。妊娠中・高血圧・生理中は避ける。'
  },
  {
    ...
    why:'即効のストレス緩和。',
    breath:'吸って、吐く息で低く長く「んー」と響かせる。',
    modify:'音は小さくてOK。1分から、目を閉じて行うと集中しやすい。'
  },
  {
    ...
    why:'顔のリラックス＋感情リリース。',
    breath:'鼻から吸い、舌を出して口から「ハー」と強く吐く。',
    modify:'声・舌は控えめでOK。数回でも十分ほぐれる。'
  },
  {
    ...
    why:'マインドフルネスの王道。',
    breath:'自然な呼吸のまま、各部位に順に意識を向ける。',
    modify:'時間は短くてOK。眠くなったら休息にしても構わない。'
  },
  {
    ...
    why:'瞑想初心者の最初の処方。',
    breath:'吐く息を1〜10まで数え、10で1に戻る。',
    modify:'5分未満でもOK。椅子に座って行ってもよい。'
  },
  {
    ...
    why:'動きながらの瞑想入門。',
    breath:'足裏の感覚に呼吸を合わせ、ゆっくり歩く。',
    modify:'短い距離を往復でOK。室内でも十分。'
  },
  {
    ...
    why:'最も楽な股関節ストレッチ。',
    breath:'深い呼吸のたびに股関節が開くのに任せる。',
    modify:'膝の下に左右クッションを置くと、力を抜いてゆだねられる。'
  },
  {
    ...
    why:'昼寝・夜の入眠に。',
    breath:'4-7-8（4吸って7止めて8吐く）のリズムで数えながら。',
    modify:'数えるのがつらければ自然な呼吸で。膝下にクッションを。'
  },
  ...
  // ============== EXPANSION PACK 1 — 立位アーサナ ==============
  {
    ...
    why:'立ち姿勢の質を整える。',
    breath:'自然な呼吸で、頭頂から吊られる感覚で立つ。',
    modify:'壁を背にして背骨の整列を確認してもよい。'
  },
  {
  ...
  },
  {
    ...
    why:'体側のストレッチと脚力。',
    breath:'吸いながら前腕を頭上へ上げ、体側を長く伸ばす。',
    modify:'後ろ手は後脚に軽く添えるだけでOK。前膝の曲げは浅く。'
  },
  {
    ...
    why:'肋間と腰方形筋の伸展。',
    breath:'吐きながら体側を、かかとから指先まで長く伸ばす。',
    modify:'前肘を前膝に置くと楽。下の手は床でなくブロックでもOK。'
  },
  {
    ...
    why:'解毒と回旋柔軟性。',
    breath:'吸って背筋を伸ばし、吐きながら胸を捻る。',
    modify:'後ろかかとを上げてOK。下の手はブロックか脛に。捻りは浅く。'
  },
  {
  ...
  },
  {
    ...
    why:'肩こり・腰痛改善の万能種目。',
    breath:'自然な呼吸で、吐く息のたびに肩甲骨の間を広げる。',
    modify:'腕だけ・脚だけの絡めでもOK。壁の近くでバランスを取る。'
  },
  {
  ...
  },
  {
    ...
    why:'内臓刺激と背骨柔軟。',
    breath:'合掌して吸い、捻りながら吐く。',
    modify:'捻りは浅くてOK。膝が内に入らない範囲で、椅子の深さも浅めに。'
  },
  ...
  // ============== EXPANSION PACK 1 — 前屈・後屈系 ==============
  {
    ...
    why:'背中・ハムストリングの解放。',
    breath:'吐きながら上体を前に垂らし、頭と首の力を抜く。',
    modify:'膝を大きく曲げてOK。手は脛や床、届く所でよい。'
  },
  {
    ...
    why:'首・肩の脱力に最適。',
    breath:'吐く息で上体を垂らし、首と肩の力を抜く。',
    modify:'膝を大きく曲げてOK。左右の肘を抱えてゆらゆら揺れると緩む。'
  },
  {
  ...
  },
  {
    ...
    why:'片脚ずつ丁寧に伸展。',
    breath:'吐く息で前屈を深め、吸って軽く戻す。',
    modify:'膝を曲げてOK。背中が丸まらない範囲で無理なく。'
  },
  {
    ...
    why:'内転筋・ハムストリングの開放。',
    breath:'吐きながら手を前へ歩かせ、上体を下ろす。',
    modify:'膝を緩め、手は床につかなくてよい。開く幅は無理のない範囲で。'
  },
  {
    ...
    why:'デスクワーク疲れに即効。',
    breath:'吸いながら胸を天井へ持ち上げ、吐いて安定させる。',
    modify:'かかとに手が届かなければ腰に手を当てたままでOK。首は倒さない。'
  },
  {
    ...
    why:'前面全体の解放。',
    breath:'吸いながら足で手を蹴り胸を開く。呼吸は止めない。',
    modify:'片脚ずつ（ハーフ弓）でOK。足首に届かなければタオルをかける。'
  },
  {
    ...
    why:'背筋強化と姿勢矯正。',
    breath:'吸いながら手脚と胸を持ち上げ、吐いて下ろす。',
    modify:'上半身だけ→次に脚だけ、と分けて行うと楽。まず5秒から。'
  },
  {
    ...
    why:'巻き肩・首の解放。',
    breath:'胸を開いたまま、ゆっくり自然な呼吸を続ける。',
    modify:'肘でしっかり支え、首に体重を乗せない。背中の下にブロックを入れて預けても。'
  },
  {
    ...
    why:'体の前面全体の最大伸展。',
    breath:'吸いながら押し上げ、キープ中も呼吸を続ける。',
    modify:'まず橋のポーズから。難しければ支持ブリッジ（お尻の下にブロック）で。'
  },
  {
    ...
    why:'初心者でもできる後屈。',
    breath:'吐きながらお尻を持ち上げ、胸を開く。',
    modify:'お尻の下にブロックを置いて体を預けると、力を抜いて胸を開ける。'
  },
  ...
  },
  {
    ...
    why:'背骨全体の伸展。',
    breath:'ゆっくり呼吸を続け、首は動かさない。',
    modify:'膝を曲げて額に近づけるだけでOK。首に不安があれば避ける。'
  },
  {
    ...
    why:'循環改善・若返り。',
    breath:'ゆっくり呼吸を続け、腰を手で支える。',
    modify:'「壁に脚を上げるポーズ」で代用OK。首に不安があれば避ける。'
  },
  {
    ...
    why:'体幹の代表種目。',
    breath:'息を吐きながら脚と胸を持ち上げV字に。キープ中も呼吸を続ける。',
    modify:'膝を曲げて脛を床と平行に（半分の舟）。手を床について支えてもOK。'
  },
  {
    ...
    why:'船への段階練習。',
    breath:'呼吸を止めず、吐く息でお腹を引き込む。',
    modify:'かかとを床につけたままでもOK。手を後ろについて支えて。'
  },
  {
    ...
    modify:'下の膝を曲げて床につけると安定する（膝つきサイドプランク）。'
  },
  {
    ...
    why:'倒立への布石。',
    breath:'前腕で床を押しながら、自然な呼吸を続ける。',
    modify:'膝を床について負荷を軽く。肩がつらければ時間を短く。'
  },
  {
    ...
    why:'集中力と体幹の融合。',
    breath:'視線を前に置き、呼吸を止めない。',
    modify:'つま先を床につけたまま体重移動の練習からでOK。前に低くクッションを置くと安心。'
  },
  ...
  // ============== EXPANSION PACK 1 — 股関節・座位 ==============
  {
    ...
    why:'股関節の最深部に届く。',
    breath:'吐く息で股関節を深く沈める。',
    modify:'後膝を床につけて負荷を軽く。肘が床に届かなければ手を床に。'
  },
  {
    ...
    why:'股関節と胸の同時開放。',
    breath:'吸いながら腕を天井へ上げ、胸を開く。',
    modify:'後膝の下にクッションを敷くと楽。腕は腰に当てたままでもOK。'
  },
  {
    ...
    why:'内転筋・股関節の解放。',
    breath:'吐きながら少しずつ膝を外へ開く。',
    modify:'開く幅を小さく。痛みが出ない範囲で、前腕で支えて。'
  },
  {
    ...
    why:'股関節の入門ストレッチ。',
    breath:'吐く息で膝を下へ、股関節をゆるめる。',
    modify:'かかとを体から離すと楽。背中が丸まれば座布団を敷く。'
  },
  {
    ...
    why:'四十肩・坐骨神経痛改善。',
    breath:'自然な呼吸で、吐く息のたびに肩をゆるめる。',
    modify:'手が届かなければタオルで上下をつなぐ。膝を重ねるのがつらければ楽な脚で。'
  },
  {
    ...
    why:'内転筋・ハムの開放。',
    breath:'吐きながら手を前へ歩かせ、上体を倒す。',
    modify:'膝を軽く曲げてOK。開く幅は無理のない範囲で。'
  },
  {
    ...
    why:'内臓刺激と解毒。',
    breath:'吸って背筋を伸ばし、吐きながら深く捻る。',
    modify:'下の脚は伸ばしたままでOK。捻りは浅く、痛みは出さない。'
  },
  {
    ...
    cues:{do:'坐骨で座る。',dont:'背中を丸めない。'},
    why:'呼吸と内観の準備。',
    breath:'背筋を伸ばし、静かに呼吸を観察する。',
    modify:'お尻の下に座布団を敷くと骨盤が立つ。壁を背にしてもOK。'
  },
  {
    ...
    why:'前ももの強烈なストレッチ。',
    breath:'深く呼吸しながら前ももの伸びを感じる。',
    modify:'お尻の下にクッションを挟むと膝が楽。痛みあれば中止。'
  },
  {
    ...
    why:'前面全体の深いストレッチ。',
    breath:'深くゆっくり呼吸し、前面をゆるめる。',
    modify:'肘で支えて上体を起こしたままでOK。膝が浮けば無理に倒れない。'
  },
  ...
  // ============== EXPANSION PACK 1 — 呼吸・瞑想 ==============
  {
    ...
    why:'自律神経の最強リセット。',
    breath:'右手で片鼻ずつ閉じ、吸う・吐くを均等にゆっくり。',
    modify:'指が疲れたら休んでOK。まず1〜2分から。'
  },
  {
  ...
  },
  {
    ...
    why:'深いリラックスへ。',
    breath:'喉を軽く絞り、波の音を立てながら吸う8秒・吐く8秒。',
    modify:'秒数はできる範囲でOK。まず1分から。'
  },
  {
  ...
  },
  {
    ...
    why:'マインドフルネスの基礎。',
    breath:'自然な呼吸のまま、足先から頭頂まで順に意識を巡らせる。',
    modify:'時間は短くてOK。仰向けがつらければ椅子でも。'
  },
  {
    ...
    why:'心の壁を溶かす。',
    breath:'ゆったり呼吸しながら、自分や大切な人へ慈しみを送る。',
    modify:'時間は短くてOK。言葉は心の中で唱えるだけでよい。'
  },
  {
    ...
    why:'集中力の根を育てる。',
    breath:'呼吸に合わせて、マントラを心の中で繰り返す。',
    modify:'声に出さず心の中でOK。短時間から始める。'
  },
  {
    ...
    why:'感情の自由を取り戻す。',
    breath:'自然な呼吸のまま、浮かんだ思いを反対の想いで置き換える。',
    modify:'短時間でOK。うまくできなくても気にしない。'
  },
];
